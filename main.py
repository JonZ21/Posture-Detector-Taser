...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if offset < 100:
            cv2.putText(
                image, str(int(offset)) + " Aligned", (w - 150, 30), font, 0.9, green, 2
            )
        else:
            cv2.putText(
                image,
                str(int(offset)) + " Not Aligned",
                (w - 150, 30),
                font,
                0.9,
                red,
        ...
        if neck_inclination < 40 and torso_inclination < 10:
            ...
            cv2.line(
                image, (l_shldr_x, l_shldr_y), (l_shldr_x, l_shldr_y - 100), green, 4
            )
            ...
            cv2.line(
                image, (l_shldr_x, l_shldr_y), (l_shldr_x, l_shldr_y - 100), red, 4
            )
